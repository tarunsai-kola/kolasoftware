...
export default function MenuListTable({ items, setItems, categories, theme, onEdit }: MenuListTableProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <select
            className="block w-full sm:w-auto pl-3 pr-10 py-2 text-sm border border-gray-200 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
            value={filterStock}
      ...
      <div className="space-y-8">
        {categories.map(category => {
          ...
          return (
            <div key={category} className="rounded-xl border border-gray-100 bg-gray-50/30 overflow-hidden">
              <div className="bg-gray-100/50 px-5 py-3 border-b border-gray-100 flex items-center justify-between">
