...
export default function HistoryClient({ orders }: { orders: HistoryOrder[] }) {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden h-full">
      ...
      {/* ── Stats Row ──────────────────────────────────────────────────────── */}
      <div className="grid grid-cols-3 gap-3 px-6 py-4 shrink-0 bg-white border-b border-gray-200">
      ...
      {/* ── Filters ────────────────────────────────────────────────────────── */}
      <div className="flex flex-wrap items-center gap-3 px-6 py-3 bg-white border-b border-gray-200 shrink-0">
        {/* Search */}
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <svg className={`h-3 w-3 text-gray-400 transition-transform ${isExpanded ? 'rotate-90' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <td className="px-4 py-3">
                          ...
                          <a href={`tel:${order.customer_phone}`} className="text-[11px] text-blue-600 hover:underline" onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* Status */}
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-[11px] font-semibold ring-1 ring-inset ${statusCfg.badge}`}>
                            {statusCfg.label}
                          </span>
                        </td>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                              ...
                              <div>
                                ...
                                <ul className="space-y-1">
                                  ...
                                  <li className="flex justify-between text-sm font-bold pt-1 border-t border-gray-200 mt-1">
